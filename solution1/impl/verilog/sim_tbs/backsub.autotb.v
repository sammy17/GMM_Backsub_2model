...
`define   AESL_DEPTH_para 1
`define AUTOTB_TVIN_gmem  "./c.backsub.autotvin_gmem.dat"
`define AUTOTB_TVIN_gmem_offset  "./c.backsub.autotvin_gmem_offset.dat"
...
`define AUTOTB_TVIN_para  "./c.backsub.autotvin_para.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.backsub.autotvin_gmem.dat"
`define AUTOTB_TVIN_gmem_offset_out_wrapc  "./rtl.backsub.autotvin_gmem_offset.dat"
...
`define AUTOTB_TVIN_para_out_wrapc  "./rtl.backsub.autotvin_para.dat"
...
reg [25 - 1 : 0] AESL_clk_ready[0 : `AUTOTB_TRANSACTION_NUM + 1];
reg [25 - 1 : 0] AESL_clk_done[0 : `AUTOTB_TRANSACTION_NUM + 1];
