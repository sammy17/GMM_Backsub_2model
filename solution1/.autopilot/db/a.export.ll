; ModuleID = '/home/zynq-fyp/Desktop/maxi_latest/GMM_Backsub_2model_edited/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@vinit = global float 1.800000e+04, align 4
@parameters = internal global [1800 x float] zeroinitializer, align 16
@out_frame = internal unnamed_addr global [300 x i1] zeroinitializer
...
@data_array = internal unnamed_addr global [300 x i8] zeroinitializer, align 16
...
@p_str1818 = private unnamed_addr constant [12 x i8] c"hls_label_3\00", align 1
@p_str1812 = private unnamed_addr constant [12 x i8] c"hls_label_1\00", align 1
@p_str1811 = private unnamed_addr constant [12 x i8] c"hls_label_2\00", align 1
...
define i32 @backsub(i8* %gmem, float* %gmem_offset, i32 %frame_in, i32 %frame_out, i1 %init, i32 %para) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(float* %gmem_offset), !map !48
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %gmem), !map !54
  call void (...)* @_ssdm_op_SpecBitsMap(i1 %init) nounwind, !map !60
...
; <label>:1                                       ; preds = %burst.wr.end33, %0
  %x = phi i9 [ 0, %0 ], [ %x_1, %burst.wr.end33 ]
  %phi_mul = phi i17 [ 0, %0 ], [ %next_mul, %burst.wr.end33 ]
  %phi_mul9 = phi i19 [ 0, %0 ], [ %next_mul1, %burst.wr.end33 ]
  %next_mul1 = add i19 %phi_mul9, 1800
  %next_mul = add i17 %phi_mul, 300
  %exitcond2 = icmp eq i9 %x, -256
...
; <label>:2                                       ; preds = %1
  ...
  %p_rd_req = call i1 @_ssdm_op_ReadReq.m_axi.floatP(float* %gmem_offset_addr, i32 1800)
  br label %burst.rd.header

burst.rd.header:                                  ; preds = %burst.rd.body, %2
  %indvar = phi i11 [ 0, %2 ], [ %indvar_next, %burst.rd.body ]
  %exitcond9 = icmp eq i11 %indvar, -248
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 1800, i64 1800, i64 1800)
...
burst.rd.body:                                    ; preds = %burst.rd.header
  ...
  %gmem_offset_addr_1 = getelementptr float* %gmem_offset, i64 %tmp_10
  %gmem_offset_addr_1_read = call float @_ssdm_op_Read.m_axi.floatP(float* %gmem_offset_addr_1)
  %tmp_6 = zext i11 %indvar to i64
  %parameters_addr = getelementptr [1800 x float]* @parameters, i64 0, i64 %tmp_6
  store float %gmem_offset_addr_1_read, float* %parameters_addr, align 4
...
burst.rd.end:                                     ; preds = %burst.rd.header
  ...
  %p_rd_req11 = call i1 @_ssdm_op_ReadReq.m_axi.i8P(i8* %gmem_addr, i32 300)
  br label %burst.rd.header14

burst.rd.header14:                                ; preds = %burst.rd.body15, %burst.rd.end
  %indvar1 = phi i9 [ 0, %burst.rd.end ], [ %indvar_next1, %burst.rd.body15 ]
  %exitcond3 = icmp eq i9 %indvar1, -212
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 300, i64 300, i64 300)
...
burst.rd.body15:                                  ; preds = %burst.rd.header14
  ...
  %gmem_addr_1 = getelementptr i8* %gmem, i64 %tmp_30
  %gmem_addr_1_read = call i8 @_ssdm_op_Read.m_axi.i8P(i8* %gmem_addr_1)
  %tmp_8 = zext i9 %indvar1 to i64
  %data_array_addr = getelementptr [300 x i8]* @data_array, i64 0, i64 %tmp_8
...
.preheader3:                                      ; preds = %burst.rd.end13, %3
  %i = phi i9 [ %i_1, %3 ], [ 0, %burst.rd.end13 ]
  %exitcond1 = icmp eq i9 %i, -212
  %i_1 = add i9 %i, 1
  br i1 %exitcond1, label %.loopexit, label %3

; <label>:3                                       ; preds = %.preheader3
  %i_cast8 = zext i9 %i to i17
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 300, i64 300, i64 300)
  ...
  %p_shl = call i12 @_ssdm_op_BitConcatenate.i12.i9.i3(i9 %i, i3 0)
  %p_shl_cast = zext i12 %p_shl to i13
  %p_shl1 = call i10 @_ssdm_op_BitConcatenate.i10.i9.i1(i9 %i, i1 false)
  %p_shl1_cast = zext i10 %p_shl1 to i13
  %tmp_11 = sub i13 %p_shl_cast, %p_shl1_cast
  %tmp_11_cast = sext i13 %tmp_11 to i32
  %tmp_12 = zext i32 %tmp_11_cast to i64
  %parameters_addr_1 = getelementptr inbounds [1800 x float]* @parameters, i64 0, i64 %tmp_12
  store float 0.000000e+00, float* %parameters_addr_1, align 8
  %tmp_13 = or i32 %tmp_11_cast, 1
  %tmp_14 = zext i32 %tmp_13 to i64
  %parameters_addr_2 = getelementptr inbounds [1800 x float]* @parameters, i64 0, i64 %tmp_14
  store float 0.000000e+00, float* %parameters_addr_2, align 4
  %tmp_15 = add i13 %tmp_11, 2
  %tmp_15_cast = sext i13 %tmp_15 to i32
  %tmp_16 = zext i32 %tmp_15_cast to i64
  %parameters_addr_3 = getelementptr inbounds [1800 x float]* @parameters, i64 0, i64 %tmp_16
  store float 4.900000e+03, float* %parameters_addr_3, align 8
  %tmp_17 = add i13 %tmp_11, 3
  %tmp_17_cast = sext i13 %tmp_17 to i32
  %tmp_18 = zext i32 %tmp_17_cast to i64
  %parameters_addr_4 = getelementptr inbounds [1800 x float]* @parameters, i64 0, i64 %tmp_18
  store float 4.900000e+03, float* %parameters_addr_4, align 4
  %tmp_19 = add i13 %tmp_11, 4
  %tmp_19_cast = sext i13 %tmp_19 to i32
  %tmp_20 = zext i32 %tmp_19_cast to i64
  %parameters_addr_5 = getelementptr inbounds [1800 x float]* @parameters, i64 0, i64 %tmp_20
  store float 0x3FB70A3D80000000, float* %parameters_addr_5, align 8
  %tmp_21 = add i13 %tmp_11, 5
  %tmp_21_cast = sext i13 %tmp_21 to i32
  %tmp_22 = zext i32 %tmp_21_cast to i64
  %parameters_addr_6 = getelementptr inbounds [1800 x float]* @parameters, i64 0, i64 %tmp_22
  store float 0x3FB70A3D80000000, float* %parameters_addr_6, align 4
  %tmp_23 = zext i9 %i to i64
  %data_array_addr_1 = getelementptr inbounds [300 x i8]* @data_array, i64 0, i64 %tmp_23
  %data_array_load = load i8* %data_array_addr_1, align 1
  %tmp_2 = call fastcc zeroext i1 @backsub_EM_ALGO(i8 zeroext %data_array_load, i9 %i, [1800 x float]* @parameters, i9 %x) nounwind
  %out_frame_addr = getelementptr [300 x i1]* @out_frame, i64 0, i64 %tmp_23
...
.preheader:                                       ; preds = %burst.rd.end13, %4
  %j = phi i9 [ %j_1, %4 ], [ 0, %burst.rd.end13 ]
  %exitcond = icmp eq i9 %j, -212
  %j_1 = add i9 %j, 1
...
; <label>:4                                       ; preds = %.preheader
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1806) nounwind
  %tmp_24 = zext i9 %j to i64
  %data_array_addr_2 = getelementptr inbounds [300 x i8]* @data_array, i64 0, i64 %tmp_24
  %data_array_load_1 = load i8* %data_array_addr_2, align 1
  %tmp_25 = call fastcc zeroext i1 @backsub_EM_ALGO(i8 zeroext %data_array_load_1, i9 %j, [1800 x float]* @parameters, i9 %x) nounwind
  %out_frame_addr_1 = getelementptr [300 x i1]* @out_frame, i64 0, i64 %tmp_24
...
.loopexit:                                        ; preds = %.preheader3, %.preheader
  ...
  %gmem_addr_2 = getelementptr i8* %gmem, i64 %tmp_36
  %p_wr_req = call i1 @_ssdm_op_WriteReq.m_axi.i8P(i8* %gmem_addr_2, i32 300)
  br label %burst.wr.header

burst.wr.header:                                  ; preds = %burst.wr.body, %.loopexit
  %indvar2 = phi i9 [ 0, %.loopexit ], [ %indvar_next2, %burst.wr.body ]
  %exitcond4 = icmp eq i9 %indvar2, -212
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 300, i64 300, i64 300)
...
burst.wr.header34.preheader:                      ; preds = %burst.wr.header
  %gmem_addr_3 = getelementptr i8* %gmem, i64 %tmp_36
  %p_wr_resp = call i1 @_ssdm_op_WriteResp.m_axi.i8P(i8* %gmem_addr_3)
  %gmem_offset_addr_2 = getelementptr float* %gmem_offset, i64 %tmp_10
  %p_wr_req12 = call i1 @_ssdm_op_WriteReq.m_axi.floatP(float* %gmem_offset_addr_2, i32 1800)
...
burst.wr.body:                                    ; preds = %burst.wr.header
  ...
  %tmp_26 = zext i9 %indvar2 to i64
  %out_frame_addr_2 = getelementptr [300 x i1]* @out_frame, i64 0, i64 %tmp_26
  %out_frame_load = load i1* %out_frame_addr_2, align 1
  %extLd = select i1 %out_frame_load, i8 -1, i8 0
  %gmem_addr_4 = getelementptr i8* %gmem, i64 %tmp_36
...
burst.wr.header34:                                ; preds = %burst.wr.header34.preheader, %burst.wr.body35
  %indvar3 = phi i11 [ %indvar_next3, %burst.wr.body35 ], [ 0, %burst.wr.header34.preheader ]
  %exitcond5 = icmp eq i11 %indvar3, -248
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 1800, i64 1800, i64 1800)
...
burst.wr.body35:                                  ; preds = %burst.wr.header34
  ...
  %empty_12 = call i32 (...)* @_ssdm_op_SpecLoopName([82 x i8]* @memcpy_OC_para_OC_backsub_IC_u) nounwind
  %tmp_28 = zext i11 %indvar3 to i64
  %parameters_addr_7 = getelementptr [1800 x float]* @parameters, i64 0, i64 %tmp_28
  %parameters_load = load float* %parameters_addr_7, align 4
  %gmem_offset_addr_4 = getelementptr float* %gmem_offset, i64 %tmp_10
  call void @_ssdm_op_Write.m_axi.floatP(float* %gmem_offset_addr_4, float %parameters_load, i4 -1)
...
burst.wr.end33:                                   ; preds = %burst.wr.header34
  %gmem_offset_addr_3 = getelementptr float* %gmem_offset, i64 %tmp_10
  %p_wr_resp13 = call i1 @_ssdm_op_WriteResp.m_axi.floatP(float* %gmem_offset_addr_3)
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str1810, i32 %tmp) nounwind
  br label %1
...
entry:
  ...
  %empty_38 = zext i1 %1 to i10
  %empty_39 = shl i10 %empty, 1
...
define internal fastcc zeroext i1 @backsub_EM_ALGO(i8 zeroext %pixel, i9 %pos_r, [1800 x float]* nocapture %parameters, i9 %x) {
meminst.0_ifconv:
  %x_read = call i9 @_ssdm_op_Read.ap_auto.i9(i9 %x)
  %pos_read = call i9 @_ssdm_op_Read.ap_auto.i9(i9 %pos_r)
  %pixel_read = call i8 @_ssdm_op_Read.ap_auto.i8(i8 %pixel)
  %tmp_s = zext i8 %pixel_read to i32
  %tmp_30 = sitofp i32 %tmp_s to float
  %p_shl = call i12 @_ssdm_op_BitConcatenate.i12.i9.i3(i9 %pos_read, i3 0)
  %p_shl_cast = zext i12 %p_shl to i13
  %p_shl2 = call i10 @_ssdm_op_BitConcatenate.i10.i9.i1(i9 %pos_read, i1 false)
  %p_shl2_cast = zext i10 %p_shl2 to i13
  %tmp_31 = sub i13 %p_shl_cast, %p_shl2_cast
  %tmp_31_cast = sext i13 %tmp_31 to i32
  %tmp_32 = add i13 2, %tmp_31
  %x_cast = zext i9 %x_read to i17
  %tmp_33 = mul i17 300, %x_cast
  %pos_cast = zext i9 %pos_read to i17
  %tmp_34 = add i17 %tmp_33, %pos_cast
  ...
  %tmp_35 = add i13 4, %tmp_31
  %tmp_36 = sext i13 %tmp_31 to i64
  %parameters_addr = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_36
  ...
  %tmp_52 = sext i13 %tmp_32 to i64
  %parameters_addr_8 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_52
  ...
  %tmp_55 = sext i13 %tmp_35 to i64
  %parameters_addr_9 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_55
  ...
  %parameters_addr_10 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_52_1
  ...
  %tmp_56_1 = add i13 3, %tmp_31
  %tmp_57_1 = sext i13 %tmp_56_1 to i64
  %parameters_addr_11 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_57_1
  ...
  %tmp_65_1 = add i13 5, %tmp_31
  %tmp_66_1 = sext i13 %tmp_65_1 to i64
  %parameters_addr_12 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_66_1
  ...
  %max_val_2_1_cast5 = zext i4 %max_val_2_1 to i13
  ...
  %min_val_1_1_cast3 = zext i4 %min_val_1_1 to i13
  br i1 %tmp_90, label %0, label %3

; <label>:0                                       ; preds = %meminst.0_ifconv
  %tmp_38 = add i13 %max_val_2_1_cast5, %tmp_31
  %tmp_39 = sext i13 %tmp_38 to i64
  %parameters_addr_13 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_39
  ...
  %tmp_44 = add i13 %max_val_2_1_cast5, %tmp_32
  %tmp_45 = sext i13 %tmp_44 to i64
  %parameters_addr_14 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_45
  ...
  %tmp_51 = add i13 %max_val_2_1_cast5, %tmp_35
  %tmp_56 = sext i13 %tmp_51 to i64
  %parameters_addr_15 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_56
...
; <label>:3                                       ; preds = %meminst.0_ifconv
  %tmp_70 = add i13 %min_val_1_1_cast3, %tmp_31
  %tmp_71 = sext i13 %tmp_70 to i64
  %parameters_addr_16 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_71
  store float %tmp_30, float* %parameters_addr_16, align 4
  %vinit_load = load float* @vinit, align 4
  %tmp_72 = add i13 %min_val_1_1_cast3, %tmp_32
  %tmp_73 = sext i13 %tmp_72 to i64
  %parameters_addr_17 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_73
...
; <label>:6                                       ; preds = %._crit_edge14.1
  ...
  %tmp_83 = add i13 %min_val_1_1_cast3, %tmp_35
  %tmp_84 = sext i13 %tmp_83 to i64
  %parameters_addr_18 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_84
  store float %tmp_82, float* %parameters_addr_18, align 4
  br label %8

; <label>:7                                       ; preds = %._crit_edge14.1
  %tmp_85 = add i13 %min_val_1_1_cast3, %tmp_35
  %tmp_86 = sext i13 %tmp_85 to i64
  %parameters_addr_19 = getelementptr [1800 x float]* %parameters, i64 0, i64 %tmp_86
...
!axi4.master.portmap = !{!43, !44}
!axi4.slave.bundlemap = !{!45, !46, !47}
...
!43 = metadata !{metadata !"gmem", metadata !"frame_in", metadata !"READONLY", metadata !"frame_out", metadata !"WRITEONLY"}
!44 = metadata !{metadata !"gmem_offset", metadata !"para", metadata !"READWRITE"}
!45 = metadata !{metadata !"frame_in", metadata !""}
!46 = metadata !{metadata !"frame_out", metadata !""}
!47 = metadata !{metadata !"para", metadata !""}
!48 = metadata !{metadata !49}
!49 = metadata !{i32 0, i32 31, metadata !50}
!50 = metadata !{metadata !51}
!51 = metadata !{metadata !"para", metadata !52, metadata !"float", i32 0, i32 31}
!52 = metadata !{metadata !53}
!53 = metadata !{i32 0, i32 460799, i32 1}
!54 = metadata !{metadata !55}
!55 = metadata !{i32 0, i32 7, metadata !56}
!56 = metadata !{metadata !57, metadata !59}
!57 = metadata !{metadata !"frame_in", metadata !58, metadata !"unsigned char", i32 0, i32 7}
!58 = metadata !{metadata !13}
!59 = metadata !{metadata !"frame_out", metadata !58, metadata !"unsigned char", i32 0, i32 7}
!60 = metadata !{metadata !61}
!61 = metadata !{i32 0, i32 0, metadata !62}
!62 = metadata !{metadata !63}
!63 = metadata !{metadata !"init", metadata !64, metadata !"bool", i32 0, i32 0}
